...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Website for Dr. Aayush Soni, an orthopedic surgeon, providing patient information and contact details." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Website for Dr. Aayush Soni, an orthopedic surgeon, providing patient information and contact details." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Website for Dr. Aayush Soni, an orthopedic surgeon, providing patient information and contact details." },
